    ...
    <div id="faq" className="faq">
      ...
      <div className="faq__questions">
        ...
        <Question question="Zijn er ook activiteiten speciaal voor kinderen?">
          <p>
            Het evenement is bedoeld voor alle leeftijden! Zo zullen de kinderen
            bijvoorbeeld de Amibots van de Breinbrouwerij kunnen bewonderen en
            op stickerzoektocht kunnen gaan.
          </p>
        </Question>
        <Question question="Is het evenement toegankelijk voor mensen met beperkte mobiliteit?">
          <p>
            ...
            beperkte mobiliteit kunnen hier gebruik maken van een lift (uitgang
            machinezaal).
          </p>
          <p>
